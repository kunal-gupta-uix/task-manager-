const {createTask, updateTask} = require('../services/taskServices');
...
const createTaskController = async (req, res) =>{
    try{
        ...
        const newTask = await createTask({sender_id,task_parent_project,task_type,task_title,task_description,task_priority,task_deadline});
...
module.exports = {createTaskController, updateTaskController};